...
>>>>>>> 791f3ca4a1d87e39c2b2de0bbc7eafb63525cbba
  return (
        ...
        <div className='mt-16'>
          ...
          <div className='mt-4'>
            <div {...getRootProps()} className={fileStyle} >
              ...
              <p className='font-poppins dark:text-white text-nft-black-1 font-semibold text-xl'>JPG, PNG, GIF, SWG, WEBM. MAX 100MB.</p>

              <div className='my-12 w-full flex justify-center'>
                <Image src={images.upload} width={100} height={100} style={{objectFit:"contain"}} alt='file upload' className={theme==="light"? "filter invert": ""}/>
              </div>
