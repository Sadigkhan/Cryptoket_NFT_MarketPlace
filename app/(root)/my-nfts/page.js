        ...
        <div className='w-full flexCenter flex-col'>
          ...
          <div className='flexCenter flex-col -mt-20 z-0'>
            <div className='flexCenter w-40 h-40 sm:w-36 sm:h-36 p-1 bg-nft-black-2 rounded-full'>
              <Image alt='profile-image' className='rounded-full object-cover' style={{objectFit:"cover"}} src={images.creator1}/>
            </div>
            <p className='font-poppins dark:text-white text-nft-black-1 font-semibold text-2xl mt-6'>{shortenAdress(currentAccount)}</p>
          </div>
        </div>
